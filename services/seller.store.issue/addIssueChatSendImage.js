...
const addIssueChatSendImage = async (req) => {
    try{
        ...
        return SellerBStoreIssueChat.create({ ...req.body, UserId: req.user.id, SellerBStoreIssueId: req.body.issueId, files: images, type: 'sent', replyBy: null});
...
module.exports = addIssueChatSendImage;